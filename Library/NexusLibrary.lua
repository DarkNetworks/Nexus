...
do
    ...
    function Utility:EnableDragging(Frame, Parent)
        ...
        local Main = CoreGui:FindFirstChild('Nexus FE Commands').Main
    ...
    function Utility:Destroy()
        ...
        for _, UI in next, CoreGui:GetChildren() do
            if UI.Name == 'Nexus FE Commands' then
...
function Library:CreateWindow(Properties)
    -- // Properties
    local Name = Utility:GetProperty('Window', 'Name', Properties) or 'Nexus Command UI Library'
    local IntroText = Utility:GetProperty('Window', 'IntroText', Properties) or 'Nexus Command UI Library'
    ...
    if IntroBlur == true then
        ...
        local Blur = Lighting.NexusIntroBlur
    ...
    if IntroBlur == true then
        Utility:Tween(Lighting.NexusIntroBlur, {Size = 0}, 1)
    ...
    if IntroBlur == true then
        Lighting.NexusIntroBlur:Destroy()
    end
    ...
    local function Execute(String)
        ...
        local Command = assert(Commands[First], '[Nexus] Command Not Found: ' .. First)
